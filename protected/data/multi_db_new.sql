...
Source Server         : my_local_db
Source Server Version : 50537
Source Host           : localhost:3306
Source Database       : ymulti

Target Server Type    : MYSQL
Target Server Version : 50537
File Encoding         : 65001

Date: 2014-06-25 13:53:59
*/
...
-- ----------------------------
-- Table structure for `access_content`
-- ----------------------------
DROP TABLE IF EXISTS `access_content`;
CREATE TABLE `access_content` (
  ...
  CONSTRAINT `access_content_ibfk_1` FOREIGN KEY (`access`) REFERENCES `access` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `access_content_ibfk_2` FOREIGN KEY (`language`) REFERENCES `languages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of access_content
-- ----------------------------
...
-- Records of admins
-- ----------------------------
INSERT INTO `admins` VALUES ('1', 'Ruslan', ' Kiricenko', 'test@xyz.com', 'f03d5649c1cacc720068448e21fcf8e4dca5acff', '616866138', '1');
...
-- ----------------------------
-- Table structure for `labels_content`
-- ----------------------------
DROP TABLE IF EXISTS `labels_content`;
CREATE TABLE `labels_content` (
  ...
  KEY `language` (`language`),
  CONSTRAINT `labels_content_ibfk_1` FOREIGN KEY (`label`) REFERENCES `labels` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `labels_content_ibfk_2` FOREIGN KEY (`language`) REFERENCES `languages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of labels_content
-- ----------------------------
...
-- ----------------------------
-- Table structure for `labels_types`
-- ----------------------------
...
-- ----------------------------
-- Table structure for `labels_types_content`
-- ----------------------------
DROP TABLE IF EXISTS `labels_types_content`;
CREATE TABLE `labels_types_content` (
  ...
  CONSTRAINT `labels_types_content_ibfk_1` FOREIGN KEY (`label`) REFERENCES `labels_types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `labels_types_content_ibfk_2` FOREIGN KEY (`language`) REFERENCES `languages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of labels_types_content
-- ----------------------------
...
INSERT INTO `languages` VALUES ('2', 'Chinese', 'cn');
INSERT INTO `languages` VALUES ('3', 'Spanish', 'sp');
INSERT INTO `languages` VALUES ('4', 'German', 'ge');

-- ----------------------------
-- Table structure for `languages_content`
-- ----------------------------
...
CREATE TABLE `languages_content` (
  ...
  KEY `language` (`language`),
  CONSTRAINT `languages_content_ibfk_1` FOREIGN KEY (`language_id`) REFERENCES `languages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `languages_content_ibfk_2` FOREIGN KEY (`language`) REFERENCES `languages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of languages_content
-- ----------------------------
INSERT INTO `languages_content` VALUES ('1', '1', 'English', 'en');
INSERT INTO `languages_content` VALUES ('1', '2', '英語', 'en');
INSERT INTO `languages_content` VALUES ('1', '3', 'Inglés', 'en');
INSERT INTO `languages_content` VALUES ('1', '4', 'Englisch', 'en');
INSERT INTO `languages_content` VALUES ('2', '1', 'Chinese', 'cn');
INSERT INTO `languages_content` VALUES ('2', '2', '中國', 'cn');
INSERT INTO `languages_content` VALUES ('2', '3', 'Chino', 'cn');
INSERT INTO `languages_content` VALUES ('2', '4', 'Chinese', 'cn');
INSERT INTO `languages_content` VALUES ('3', '1', 'Spanish', 'sp');
INSERT INTO `languages_content` VALUES ('3', '2', '西班牙', 'sp');
INSERT INTO `languages_content` VALUES ('3', '3', 'Español', 'sp');
INSERT INTO `languages_content` VALUES ('3', '4', 'Spanisch', 'sp');
INSERT INTO `languages_content` VALUES ('4', '1', 'German', 'ge');
INSERT INTO `languages_content` VALUES ('4', '2', '德國', 'ge');
INSERT INTO `languages_content` VALUES ('4', '3', 'Alemán', 'ge');
INSERT INTO `languages_content` VALUES ('4', '4', 'Deutsch', 'ge');
...
CREATE TABLE `navigation` (
  ...
  KEY `fk_type` (`type`),
  KEY `fk_page` (`page`),
  CONSTRAINT `navigation_ibfk_1` FOREIGN KEY (`type`) REFERENCES `navigation_types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `navigation_ibfk_2` FOREIGN KEY (`page`) REFERENCES `pages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of navigation
-- ----------------------------
INSERT INTO `navigation` VALUES ('2', '1', '3', '3', '0');
INSERT INTO `navigation` VALUES ('4', '1', '5', '4', '0');
INSERT INTO `navigation` VALUES ('5', '1', '6', '2', '0');
INSERT INTO `navigation` VALUES ('34', '3', '6', '2', '0');
INSERT INTO `navigation` VALUES ('35', '1', '4', '1', '0');
INSERT INTO `navigation` VALUES ('36', '3', '4', '1', '0');
INSERT INTO `navigation` VALUES ('42', '2', '5', '1', '0');
...
-- ----------------------------
-- Table structure for `navigation_types_content`
-- ----------------------------
DROP TABLE IF EXISTS `navigation_types_content`;
CREATE TABLE `navigation_types_content` (
  ...
  KEY `language` (`language`),
  CONSTRAINT `navigation_types_content_ibfk_1` FOREIGN KEY (`navigation`) REFERENCES `navigation_types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `navigation_types_content_ibfk_2` FOREIGN KEY (`language`) REFERENCES `languages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of navigation_types_content
-- ----------------------------
...
CREATE TABLE `pages_content` (
  ...
  KEY `language` (`language`),
  CONSTRAINT `pages_content_ibfk_1` FOREIGN KEY (`language`) REFERENCES `languages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `pages_content_ibfk_2` FOREIGN KEY (`page`) REFERENCES `pages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
