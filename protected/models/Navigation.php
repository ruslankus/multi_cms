 ...
 * @property NavigationTypes $type0
...
class Navigation extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('type, page, priority', 'required'),
			array('type, order, priority', 'numerical', 'integerOnly'=>true),
			array('page', 'length', 'max'=>11),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, type, page, order, priority', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'type0' => array(self::BELONGS_TO, 'NavigationTypes', 'type'),
			'page0' => array(self::BELONGS_TO, 'Pages', 'page'),
            'page_content' => array(self::BELONGS_TO, 'PagesContent', 'page'),
		);
	}
